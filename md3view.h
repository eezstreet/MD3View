...
#define sRAVEN "(This version produced by eezstreet, with credit to Scooper)"

#define ABOUT_TEXT          "\n\n " FILENAME "\t\n\n" \
							"A q3test model viewer\t\n\n" \
							"Original credits: Sander 'FireStorm' van Rossen,\n" \
							"Matthew 'pagan' Baranowski, Ste Corke\n\n" \
							"New features in 1.7:\n" \
							"- Load FBX models\n" \
							"- Smarter texture loading (no crash, uses absolute paths better)\n\n" \
							"Source code can be found at Github: eezstreet/MD3View\n\n" \
							sRAVEN
